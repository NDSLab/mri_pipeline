...
matlabbatch{9}.spm.spatial.coreg.estimate.ref(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^me\S*\.nii$)', substruct('.','val', '{}',{7}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{9}.spm.spatial.coreg.estimate.source(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^s\S*\.nii$)', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
matlabbatch{10}.spm.spatial.preproc.channel.vols(1) = cfg_dep('Coregister: Estimate: Coregistered Images', substruct('.','val', '{}',{9}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','cfiles'));
...
matlabbatch{10}.spm.spatial.preproc.tissue(1).tpm = {'/home/common/matlab/spm12/tpm/TPM.nii,1'};
...
matlabbatch{10}.spm.spatial.preproc.tissue(2).tpm = {'/home/common/matlab/spm12/tpm/TPM.nii,2'};
...
matlabbatch{10}.spm.spatial.preproc.tissue(3).tpm = {'/home/common/matlab/spm12/tpm/TPM.nii,3'};
...
matlabbatch{10}.spm.spatial.preproc.tissue(4).tpm = {'/home/common/matlab/spm12/tpm/TPM.nii,4'};
...
matlabbatch{10}.spm.spatial.preproc.tissue(5).tpm = {'/home/common/matlab/spm12/tpm/TPM.nii,5'};
...
matlabbatch{10}.spm.spatial.preproc.tissue(6).tpm = {'/home/common/matlab/spm12/tpm/TPM.nii,6'};
...
matlabbatch{10}.spm.spatial.preproc.warp.samp = 2;
